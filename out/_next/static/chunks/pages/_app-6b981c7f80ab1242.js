  ...
  [888, 217],
  {
    ...
    3562: function(e, t, n) {
      ...
      var o = (function(e) {
        ...
        i = _interopRequireDefault(n(5697)),
        r = _interopRequireDefault(n(644)),
        a = _interopRequireDefault(n(129)),
        s = n(4726);
      ...
      function shouldDelayEnter(e) {
        return o.default.isValidElement(e) && e.type.pageTransitionDelayEnter;
      }
      ...
      var l = (function(e) {
        ...
        function PageTransition(e) {
          !(function(e, t) {
            ...
            (n =
              (t = _getPrototypeOf(PageTransition).call(this, e)) &&
            ...
            _defineProperty(
              ...
              'onEntering',
              makeStateUpdater('entering').bind(_assertThisInitialized(n))
            ),
            _defineProperty(
              _assertThisInitialized(n),
              'onEntered',
              makeStateUpdater('entered').bind(_assertThisInitialized(n))
            ),
            _defineProperty(
              _assertThisInitialized(n),
              'onExiting',
              makeStateUpdater('exiting').bind(_assertThisInitialized(n))
            ),
            _defineProperty(
              _assertThisInitialized(n),
              'onExited',
              makeStateUpdater('exited', { renderedChildren: null }).bind(
                _assertThisInitialized(n)
              )
            );
          var t,
        ...
        return (
          ...
          (t = [
                ...
                var n = this.state,
                  ...
                  m =
                    ...
                    (!r ||
                      ...
                      o.default.isValidElement(c)
                        ? null == r.key || null == c.key
                          ? (console.warn(
                        ...
                        : (console.warn(
                          ...
                          !0)));
                s && h && !m
                  ? this.setState({ currentChildren: c, renderedChildren: c })
                  : f
                  ? (this.setState({
                      isIn: !1,
                      nextChildren: c,
                  ...
                  : t.showLoading && !d && this.setState({ isIn: !0 });
              },
            },
            {
            ...
            },
            {
              ...
              value: function() {
                (this.disableScrolling = !1),
                  this.setState({ state: 'enter', showLoading: !1 });
              },
            },
            {
              key: 'onExit',
            ...
            },
            {
              ...
              value: function() {
                var e = this,
                  ...
                  c = t.classNames,
                  p = t.loadingClassNames,
                  u = t.loadingTimeout,
                  d = t.skipInitialTransition,
                  f = this.state,
                  h = f.renderedChildren,
                  m = f.state,
                  g = f.isIn,
                  y = f.showLoading;
                -1 !== ['entering', 'exiting', 'exited'].indexOf(m) &&
                  document.body &&
          ...
          _defineProperties(PageTransition.prototype, t),
          n && _defineProperties(PageTransition, n),
          PageTransition
        );
      })(o.default.Component);
      (l.propTypes = {
        ...
        classNames: i.default.string.isRequired,
        timeout: function(e) {
          if (s.timeoutsShape) {
            for (
              ...
              n[o - 1] = arguments[o];
            return s.timeoutsShape.isRequired.apply(
              s.timeoutsShape,
              [e].concat(n)
            );
          }
        },
        loadingComponent: i.default.element,
        loadingDelay: i.default.number,
        loadingCallbackName: i.default.string,
        ...
        monkeyPatchScrolling: i.default.bool,
        skipInitialTransition: i.default.bool,
      }),
        (l.defaultProps = {
          tag: 'div',
    ...
    3504: function(e, t, n) {
      'use strict';
      var o,
        i = (o = n(3562)) && o.__esModule ? o : { default: o };
      e.exports = { PageTransition: i.default };
    },
    7544: function(e, t, n) {
      e.exports = n(5217);
    },
      ...
      t.Z = [
        {
          ...
          imageUrl: 'https://i.ibb.co/PzPJ00Zv/Capture2.png',
          type: ['publication'],
        },
        {
          title:
            'Ethical Implications of Lethal Autonomous Weapons Systems (LAWS)',
          description:
        ...
        },
        {
          ...
          imageUrl: 'https://i.ibb.co/4RCpHTHL/asdasd.png',
          type: ['article'],
        },
        {
          ...
          imageUrl: 'https://i.ibb.co/bRG0VN0h/asdasdasd.png',
          type: ['article'],
        },
        {
          title:
            'Evolution of Machine Vision: Industry and Humanitarian Implications ',
          description:
          ...
          imageUrl: 'https://i.ibb.co/TDhZ18nT/324234234.png',
          type: ['article'],
        },
        {
          ...
          imageUrl: 'https://i.ibb.co/m5ynyX9Y/12341234.png',
          type: ['article'],
        },
        {
          ...
          imageUrl: 'https://i.ibb.co/vCrv4Lkd/123123123.png',
          type: ['article'],
        },
        {
          ...
          imageUrl: 'https://i.ibb.co/vx1sQfNK/412341.png',
          type: ['article'],
        },
        {
          ...
          imageUrl: 'https://i.ibb.co/20NtpDTz/1341234.png',
          type: ['article'],
        },
        {
          ...
          imageUrl: 'https://i.ibb.co/k22h5Bk7/1234123412.png',
          type: ['article'],
        },
        {
          ...
          imageUrl: 'https://i.ibb.co/CKVkdD1G/123123.png',
          type: ['article'],
        },
      ];
    },
      ...
      t.Z = [
        {
          ...
          link:
            'https://www.selectspecs.com/sunglasses/ray-ban/rb3539/ss105.57.html',
    ...
    1914: function(e, t) {
      ...
      t.Z = [
        ...
        },
        {
          ...
          about:
            'A Raspberry Pi computer capable of object following, conversation, as well as updates',
          description:
        ...
        },
        {
          title: 'Smart Mirror',
          description:
            'Smart mirror capable of holding conversations and providing information on attached widgets.',
        ...
        {
          title: 'H.AI.D.E.S',
          description: 'Autonomy in safety and defense',
          about:
          ...
          imageUrl: 'https://i.ibb.co/Nd6vFLrR/P2120607.jpg',
          type: ['ai-ml', 'robotics'],
          technologies: [
            'Python',
            'Muli TPU',
        ...
        },
        {
          ...
          description:
            'My first video walkthrough on my computer vision facial recognition - 2019',
          about:
        ...
        },
        {
          ...
          about:
            'Deep Learning into taking a patient profile, location, as well as a medical image to estimate the likely cost of care for likely diagnosis.',
          link: 'https://github.com/jordanholbrook/CV_Med',
        ...
        },
        {
          ...
          description:
            'Highlighting policy transparency aggregating data across government agencies ',
          about:
            'Tangential to the government transparency act, voquo was founded to partner with Databricks and Snowflake to offer free government datasets for easier, public access.',
          link: 'https://www.voquo.io/',
        ...
        },
        {
          ...
          description:
            'SHA-265 and PostgreSQL MD5 Encryption for Dual-Serialization',
          about:
            'A password manager with two step serialization for passwords using SHA-256 on the intake and MD5 on the database update. Build on encryption through network and SSL of course.',
          link: 'https://www.voquo.io/',
          imageUrl:
            'https://i.ibb.co/Kzsjy1sY/68747470733a2f2f692e6962622e636f2f774a524832776e2f686f6d652e706e67.png',
          type: ['open-source'],
          technologies: [
            'Python',
            'Django',
        ...
        },
        {
          ...
          description:
            'Contributor on the great expectations data validation framework',
          about:
            'Created PRs for validation checks that I needed in various work pipelines. Ended up becoming a contributor on the framework',
          link: 'https://greatexpectations.io/expectations/',
    ...
    8136: function(e, t, n) {
      ...
      var o = n(7294),
        ...
        a = n(1914),
        s = (0, o.createContext)({}),
        l = (0, o.createContext)(i.Z),
        c = (0, o.createContext)(r.Z),
        p = (0, o.createContext)(a.Z);
      t.ZP = s;
    },
    5217: function(e, t, n) {
      'use strict';
      ...
      var p = n(8754)._(n(7294)),
        u = n(3819);
      function appGetInitialProps(e) {
        return _appGetInitialProps.apply(this, arguments);
      }
      function _appGetInitialProps() {
        return (_appGetInitialProps = c(
                ...
                switch ((o.prev = o.next)) {
                  case 0:
                    return (
                      ...
                      (n = e.ctx),
                      (o.next = 3),
                      (0, u.loadGetInitialProps)(t, n)
                    );
                  case 3:
                    return (i = o.sent), o.abrupt('return', { pageProps: i });
                  case 5:
                  case 'end':
                    return o.stop();
                }
      ...
      var d = (function(e) {
        ...
        function App() {
          return i(this, App), n.apply(this, arguments);
        }
        return (
          r(App, [
            {
      ...
      (d.origGetInitialProps = appGetInitialProps),
        (d.getInitialProps = appGetInitialProps),
      ...
      var f = (function(e) {
        ...
        function MyApp() {
          ...
          return (
            ...
            (e = u.call(this)),
            (0, i.Z)(_assertThisInitialized(e), 'loadTheme', function() {
              !1 == e.state.theme ? clearState() : saveState(1);
            }),
            (0, i.Z)(_assertThisInitialized(e), 'handleopen', function() {
              var t = e.state.show;
              e.setState({ show: !t });
            }),
            (0, i.Z)(_assertThisInitialized(e), 'setTheme', function() {
              var t = e.state.theme;
              e.setState({ theme: !t });
            }),
            (0, i.Z)(_assertThisInitialized(e), 'closeShow', function() {
              e.setState({ show: !1 });
            }),
            (e.state = { show: !1, theme: !!loadState() }),
            e
          );
        }
        return (
          (s = [
            {
              ...
              value: function() {
                ...
                return (0, d.jsx)(d.Fragment, {
                  children: (0, d.jsx)(c.PageTransition, {
                    timeout: 200,
              ...
              value:
                    ...
                    for (;;)
                      switch ((i.prev = i.next)) {
                        case 0:
                          ...
                          return (i.next = 5), t.getInitialProps(n);
                        case 5:
                          o = i.sent;
                        case 6:
                          return i.abrupt('return', { pageProps: o });
                        case 7:
                        case 'end':
                          return i.stop();
                      }
                ...
                (r = function() {
                  ...
                  return new Promise(function(o, i) {
                    var r = n.apply(e, t);
                    function _next(e) {
                      asyncGeneratorStep(r, o, i, _next, _throw, 'next', e);
                    }
                    function _throw(e) {
                      asyncGeneratorStep(r, o, i, _next, _throw, 'throw', e);
                    }
                    _next(void 0);
                  });
                }),
          ...
          s && _defineProperties(MyApp.prototype, s),
          l && _defineProperties(MyApp, l),
          MyApp
        );
      })(l());
    },
    ...
    129: function(e, t, n) {
      ...
      var o = _interopRequireDefault(n(8141)),
        i = _interopRequireDefault(n(602)),
        r = _interopRequireDefault(n(7294)),
        a = _interopRequireDefault(n(644));
      function _interopRequireDefault(e) {
        return e && e.__esModule ? e : { default: e };
      }
      function _extends() {
      ...
      var addClass = function(e, t) {
        ...
        s = (function(e) {
          function CSSTransition() {
            ...
            return (
              ((t =
                e.call.apply(e, [this].concat(o)) || this).onEnter = function(
                e,
                n
              ) {
              ...
              (t.getClassNames = function(e) {
                var n = t.props.classNames,
                  o = 'string' == typeof n,
                  i = o ? (o && n ? n + '-' : '') + e : n[e],
                  r = o ? i + '-active' : n[e + 'Active'],
                  a = o ? i + '-done' : n[e + 'Done'];
                return { className: i, activeClassName: r, doneClassName: a };
              }),
              t
            );
          }
          (CSSTransition.prototype = Object.create(e.prototype)),
            (CSSTransition.prototype.constructor = CSSTransition),
            (CSSTransition.__proto__ = e);
    ...
    644: function(e, t, n) {
      ...
      var o = (function(e) {
        ...
        i = _interopRequireDefault(n(7294)),
        r = _interopRequireDefault(n(3935)),
        a = n(6871);
      function _interopRequireDefault(e) {
        return e && e.__esModule ? e : { default: e };
      }
