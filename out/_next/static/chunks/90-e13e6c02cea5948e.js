  ...
  [90],
  {
    9090: function(t, e, i) {
      ...
      function isControllingVariants(t) {
        return (
          isAnimationControls(t.animate) || d.some((e) => isVariantLabel(t[e]))
        );
      }
      ...
      let p = {
        ...
        m = {};
      for (let t in p) m[t] = { isEnabled: (e) => p[t].some((t) => !!e[t]) };
      ...
      let isMotionValue = (t) => !!(t && t.getVelocity),
        ...
        A = checkStringStartsWith('--'),
        S = checkStringStartsWith('var(--'),
        getValueAsType = (t, e) =>
      ...
      let createUnitType = (t) => ({
        ...
        O = {
          ...L,
          parse: (t) => L.parse(t) / 100,
          transform: (t) => L.transform(100 * t),
        },
        I = { ...D, transform: Math.round },
        N = {
          borderWidth: R,
          borderTopWidth: R,
          borderRightWidth: R,
      ...
      try {
        (n = require('@emotion/is-prop-valid').default) &&
          (shouldForward = (t) =>
            t.startsWith('on') ? !isValidMotionProp(t) : n(t));
      } catch (t) {}
      function calcOrigin(t, e, i) {
        return 'string' == typeof t ? t : R.transform(e + i * t);
      }
      ...
      function useSVGProps(t, e, i, n) {
        ...
        if (t.style) {
          let e = {};
          copyRawValuesOnly(e, t.style, t), (s.style = { ...e, ...s.style });
        }
        return s;
      }
      let camelToDash = (t) =>
      ...
      function renderSVG(t, e, i, n) {
        for (let i in (renderHTML(t, e, void 0, n), e.attrs))
          t.setAttribute(G.has(i) ? i : camelToDash(i), e.attrs[i]);
      }
      ...
      let Z = { delta: 0, timestamp: 0, isProcessing: !1 },
        X = !0,
        Y = !1,
        ...
        processStep = (t) => J[t].process(Z),
        processFrame = (t) => {
          (Y = !1),
            (Z.delta = X
              ? 1e3 / 60
              : Math.max(Math.min(t - Z.timestamp, 40), 1)),
            (Z.timestamp = t),
            (Z.isProcessing = !0),
            K.forEach(processStep),
            (Z.isProcessing = !1),
            Y && ((X = !1), requestAnimationFrame(processFrame));
        },
        startLoop = () => {
          (Y = !0),
            (X = !0),
            Z.isProcessing || requestAnimationFrame(processFrame);
        },
        Q = K.reduce((t, e) => {
          let i = J[e];
          return (
            (t[e] = (t, e = !1, n = !1) => (
              Y || startLoop(), i.schedule(t, e, n)
            )),
            t
          );
        }, {});
      function cancelFrame(t) {
        K.forEach((e) => J[e].cancel(t));
      }
      ...
      let tn = 'data-' + camelToDash('framerAppearId'),
        secondsToMilliseconds = (t) => 1e3 * t,
        ...
        tl = {};
      for (let t in ta)
        tl[t] = () => (void 0 === to[t] && (to[t] = ta[t]()), to[t]);
      let calcBezier = (t, e, i) =>
        (((1 - 3 * i + 3 * e) * t + (3 * i - 6 * e)) * t + 3 * e) * t;
      function cubicBezier(t, e, i, n) {
        if (t === e && i === n) return noop;
        let getTForX = (e) =>
          (function(t, e, i, n, r) {
            let s, a;
            let o = 0;
      ...
      let tu = cubicBezier(0.42, 0, 1, 1),
        th = cubicBezier(0, 0, 0.58, 1),
        tc = cubicBezier(0.42, 0, 0.58, 1),
        ...
        td = reverseEasing(circIn),
        tp = mirrorEasing(td),
        tm = cubicBezier(0.33, 1.53, 0.69, 0.99),
        tf = reverseEasing(tm),
        tg = mirrorEasing(tf),
        ty = {
          linear: noop,
        ...
        easingDefinitionToFunction = (t) => {
          ...
          return 'string' == typeof t
            ? (noop(void 0 !== ty[t], `Invalid easing type '${t}'`), ty[t])
            : t;
        },
        isColorString = (t, e) => (i) =>
          !!(
            (isString(i) && B.test(i) && i.startsWith(t)) ||
            (e && Object.prototype.hasOwnProperty.call(i, e))
          ),
        splitColor = (t, e, i) => (n) => {
          if (!isString(n)) return n;
          let [r, s, a, o] = n.match(M);
          return {
            [t]: parseFloat(r),
            [e]: parseFloat(s),
            [i]: parseFloat(a),
        ...
        tv = { ...D, transform: (t) => Math.round(clampRgbUnit(t)) },
        tx = {
        ...
        tV = {
          ...
          transform: ({ hue: t, saturation: e, lightness: i, alpha: n = 1 }) =>
            ...
            Math.round(t) +
            ', ' +
            L.transform(sanitize(e)) +
            ', ' +
            L.transform(sanitize(i)) +
            ', ' +
            sanitize(C.transform(n)) +
            ')',
        },
        tT = {
          test: (t) => tx.test(t) || tP.test(t) || tV.test(t),
          parse: (t) =>
            tx.test(t) ? tx.parse(t) : tV.test(t) ? tV.parse(t) : tP.parse(t),
          transform: (t) =>
            isString(t)
              ? t
      ...
      let mixLinearColor = (t, e, i) => {
        ...
        tb = [tP, tx, tV],
        getColorType = (t) => tb.find((e) => e.test(t));
      function asRGBA(t) {
      ...
      let mixColor = (t, e) => {
        ...
        tS = { regex: w, countKey: 'Colors', token: '${c}', parse: tT.parse },
        tD = { regex: M, countKey: 'Numbers', token: '${n}', parse: D.parse };
      ...
      function analyseComplexValue(t) {
        ...
        return (
          i.value.includes('var(--') && tokenise(i, tA),
          tokenise(i, tS),
          tokenise(i, tD),
          i
        );
      ...
      function createTransformer(t) {
        ...
        return (t) => {
          ...
          for (let r = 0; r < s; r++)
            e =
              r < n
                ? e.replace(tA.token, t[r])
                : r < n + i
                ? e.replace(tS.token, tT.transform(t[r]))
                : e.replace(tD.token, sanitize(t[r]));
          return e;
        };
      }
      ...
      function interpolate(t, e, { clamp: i = !0, ease: n, mixer: r } = {}) {
        ...
        let a = (function(t, e, i) {
              ...
              r =
                ...
                (function(t) {
                  if ('number' == typeof t);
                    ...
                    return tT.test(t) ? mixColor : mixComplex;
            ...
            for (let i = 0; i < s; i++) {
              let s = r(t[i], t[i + 1]);
              if (e) {
                let t = Array.isArray(e) ? e[i] || noop : e;
                s = pipe(t, s);
              }
              n.push(s);
            }
        ...
        let r = isEasingArray(n)
          ...
          o = interpolate(a, e, {
            ease: Array.isArray(r)
              ? r
              : e.map(() => r || tc).splice(0, e.length - 1),
          });
        return {
      ...
      function spring({ keyframes: t, restDelta: e, restSpeed: i, ...n }) {
        ...
        let s = t[0],
          ...
          o = { done: !1, value: s },
          {
            ...
            if (!isSpringType(t, tM) && isSpringType(t, tE)) {
              let i = (function({
                duration: t = 800,
                bounce: e = 0.25,
                velocity: i = 0,
      ...
      let frameloopDriver = (t) => {
        ...
        return {
          start: () => Q.update(passTimestamp, !0),
      ...
      function animateValue({
        ...
        let { calculatedDuration: D } = V,
          C = 1 / 0,
          E = 1 / 0;
        null !== D && (E = (C = D + a) * (s + 1) - a);
        let M = 0,
          tick = (t) => {
            if (null === A) return;
            v > 0 && (A = Math.min(A, t)), (M = null !== b ? b : (t - A) * v);
            let i = M - e,
              r = i < 0;
            ...
            let p =
              null === b &&
              ('finished' === T || ('running' === T && d) || (v < 0 && M <= 0));
        ...
        if (
          ...
          let i = (function(t, e, { onUpdate: i, onComplete: n, ...r }) {
            ...
            let p = (function(
              ...
              safeCancel = () => {
                Q.update(cancelAnimation), s(), updateFinishedPromise();
              };
            return (
              (p.onfinish = () => {
                t.set(
              ...
              }),
              {
                ...
                play: () => {
                  l || (p.play(), cancelFrame(cancelAnimation));
                },
                pause: () => p.pause(),
                stop: () => {
        ...
        constructor(t, e = {}) {
          (this.version = '10.12.12'),
            ...
            (this.scheduleVelocityCheck = () =>
              Q.postRender(this.velocityCheck)),
      ...
      let testValueType = (t) => (e) => e.test(t),
        tN = [D, R, L, k, j, F, { test: (t) => 'auto' === t, parse: (t) => t }],
        findDimensionValueType = (t) => tN.find(testValueType(t)),
        tU = [...tN, tT, tC],
      ...
      function animateTarget(
        ...
        for (let e in o) {
          ...
          if (
            ...
            continue;
          let a = { delay: i, elapsed: 0, ...s };
          if (window.HandoffAppearAnimations && !n.hasAnimated) {
            let i = t.getProps()[tn];
            i && (a.elapsed = window.HandoffAppearAnimations(i, e, n, Q));
          }
          n.start(
            animateMotionValue(
              e,
          ...
          let c = n.animation;
          isWillChangeMotionValue(l) && (l.add(e), c.then(() => l.remove(e))),
            u.push(c);
        }
        return (
          a &&
              ...
              a &&
                (function(t, e) {
                  let i = resolveVariant(t, e),
                    { transitionEnd: n = {}, transition: r = {}, ...s } = i
                      ? t.makeTargetAnimatable(i, !1)
                      : {};
                  for (let e in (s = { ...s, ...n })) {
      ...
      let t$ = ['x', 'scaleX', 'originX'],
        tW = ['y', 'scaleY', 'originY'];
      function transformBox(t, e) {
        transformAxis(t.x, e, t$), transformAxis(t.y, e, tW);
      }
      ...
      let MeasureLayoutWithContext = class MeasureLayoutWithContext extends r.Component {
        componentDidMount() {
          let {
              visualElement: t,
              layoutGroup: e,
      ...
      function MeasureLayout(t) {
        let [e, i] = (function() {
          ...
          n = (0, r.useContext)(f);
        return r.createElement(MeasureLayoutWithContext, {
          ...t,
          layoutGroup: n,
      ...
      let tX = {
        ...
        isPx = (t) => 'number' == typeof t || R.test(t);
      function getRadius(t, e) {
        return void 0 !== t[e] ? t[e] : t.borderRadius;
      }
      let tJ = compress(0, 0.5, td),
        tQ = compress(0.5, 0.95, noop);
      ...
      function removeBoxTransforms(t, e, i, n) {
        removeAxisTransforms(t.x, e, t0, i ? i.x : void 0, n ? n.x : void 0),
          removeAxisTransforms(t.y, e, t1, i ? i.y : void 0, n ? n.y : void 0);
      }
      ...
      function createProjectionNode({
        ...
        return class {
          constructor(t = {}, i = null == e ? void 0 : e()) {
            (this.id = t2++),
              ...
              (this.updateProjection = () => {
                (t3.totalNodes = t3.resolvedTargetDeltas = t3.recalculatedProjection = 0),
                  this.nodes.forEach(propagateDirtyNodes),
                  this.nodes.forEach(resolveTargetDelta),
                  this.nodes.forEach(calcProjection),
                  this.nodes.forEach(cleanDirtyNodes),
                  window.MotionDebug && window.MotionDebug.record(t3);
              }),
              (this.hasProjected = !1),
              (this.isVisible = !0),
                  ...
                  (i = (function(t, e) {
                    let i = performance.now(),
                      checkElapsed = ({ timestamp: n }) => {
                        let r = n - i;
                        r >= e && (cancelFrame(checkElapsed), t(r - e));
                      };
                    return (
                      Q.read(checkElapsed, !0), () => cancelFrame(checkElapsed)
                    );
                  })(resizeUnblockUpdate, 250)),
                  t_.hasAnimatedSinceResize &&
                    ((t_.hasAnimatedSinceResize = !1),
          ...
          setAnimationOrigin(t, e = !1) {
            ...
            (this.animationProgress = 0),
              (this.mixTargetDelta = (e) => {
                var n, l;
                let u = e / 1e3;
                mixAxisDelta(a.x, t.x, u),
                  mixAxisDelta(a.y, t.y, u),
                  ...
                  this.relativeTarget &&
                    ...
                    mixAxis(n.x, l.x, o.x, u),
                    mixAxis(n.y, l.y, o.y, u),
                    i &&
          ...
          getProjectionStyles(t = {}) {
            ...
            for (let t in ((n.transformOrigin = `${100 * o.origin}% ${100 *
              l.origin}% 0`),
            s.animationValues
              ? (n.opacity =
                  s === this
      ...
      let t9 = { duration: 0.45, ease: [0.4, 0, 0.1, 1] };
      ...
      function getVariableValue(t, e, i = 1) {
        ...
        return s ? s.trim() : S(r) ? getVariableValue(r, e, i + 1) : r;
      }
      let et = new Set([
          'width',
          'height',
        ...
        convertChangedValueTypes = (t, e, i) => {
              ...
              if (isKeyframesTarget(d)) {
                ...
                for (let i = e; i < t && null !== d[i]; i++)
                  l
                    ...
                    : noop(
                        (l = findDimensionValueType(d[i])) === c ||
                          (isNumOrPxType(c) && isNumOrPxType(l)),
      ...
      let VisualElement = class VisualElement {
        ...
        unmount() {
          for (let t in (ea.delete(this.current),
        ...
        readValueFromInstance(t, e) {
          ...
          }
          {
            let i = window.getComputedStyle(t),
              n = (A(e) ? i.getPropertyValue(e) : i[e]) || 0;
      ...
      let SVGVisualElement = class SVGVisualElement extends DOMVisualElement {
        ...
        readValueFromInstance(t, e) {
          ...
          return (e = G.has(e) ? e : camelToDash(e)), t.getAttribute(e);
        }
            ...
            Feature: class extends Feature {
              ...
              createPanHandlers() {
                ...
                return {
                  ...
                  onMove: i,
                  onEnd: (t, e) => {
                    delete this.session, n && Q.update(() => n(t, e));
                  },
                };
              }
              mount() {
        ...
        ed = (function(t) {
          function custom(e, i = {}) {
            return (function({
              ...
              let d = (0, r.forwardRef)(function(d, p) {
                var m;
                let y;
                let v = {
                    ...(0, r.useContext)(s),
                  ...
                  P = (function(t) {
                    ...
                    return (0, r.useMemo)(() => ({ initial: e, animate: i }), [
                ...
                if (!x && l) {
                  P.visualElement = (function(t, e, i, n) {
                    let { visualElement: l } = (0, r.useContext)(a),
                      c = (0, r.useContext)(h),
                      d = (0, r.useContext)(o),
                    ...
                    let g = window.HandoffAppearAnimations ? u : r.useEffect;
                    return (
                      g(() => {
                        f &&
                          f.animationState &&
                  ...
                  P.visualElement &&
                    (y = P.visualElement.loadFeatures(v, n, t, i));
                }
          ...
          (function(t, { forwardMotionProps: e = !1 }, i, n) {
            let s = isSVGComponent(t) ? $ : W;
            return {
              ...s,
              preloadedFeatures: i,
              useRender: (function(t = !1) {
                return (e, i, n, { latestValues: s }, a) => {
                  let o = isSVGComponent(e) ? useSVGProps : useHTMLProps,
                    ...
                    h = { ...u, ...l, ref: n },
                    { children: c } = i,
                    d = (0, r.useMemo)(() => (isMotionValue(c) ? c.get() : c), [
                      c,
                    ]);
          ...
          })(t, e, ec, create_visual_element_createDomVisualElement)
        );
    },
  },
]);
